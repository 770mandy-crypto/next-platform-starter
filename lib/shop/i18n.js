...
export const dict = {
    he: {
        ...
        sections: {
            ...
            more: 'עוד מהקולקציה',
            moreSub: 'פריטים מקטגוריות אחרות שהולכים טוב יחד'
        },
        search: {
            title: 'חיפוש',
    ...
    en: {
        ...
        sections: {
            ...
            more: 'More from the collection',
            moreSub: 'Pieces from other categories that sit well together'
        },
        search: {
            title: 'Search',
